...
class_precision_parameter(start_small_omega_tau,double,0.01) /**< value of omega*tau which gives an upper value for the starting tau when integrating vector modes. Decrease to start earlier in time*/
