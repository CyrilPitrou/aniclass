...
struct transfer {
  ...
  int index_tt_t1_v;      /**< index for transfer type = temperature for vector mode (j=1, m=1 term) */
  int index_tt_b_v;       /**< index for transfer type = B-polarization for vector modes (m=1) */
