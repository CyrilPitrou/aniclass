  ...
  for (index_q=0; index_q < ptr->q_size; index_q++) {
    ...
    if (ppt->has_cl_cmb_temperature == _TRUE_) {
      ...
      if (_vectors_) {
        ...
        transfer_ic1_temp = transfer_ic1[ptr->index_tt_t1_v] + transfer_ic1[ptr->index_tt_t2];
        transfer_ic2_temp = transfer_ic2[ptr->index_tt_t1_v] + transfer_ic2[ptr->index_tt_t2];
    ...
    */
    ...
    if (_vectors_ && (phr->has_bb == _TRUE_))
      cl_integrand[index_q*cl_integrand_num_columns+1+phr->index_ct_bb]=
        primordial_pk[index_ic1_ic2]
        * transfer_ic1[ptr->index_tt_b_v]
        * transfer_ic2[ptr->index_tt_b_v]
        * factor;
