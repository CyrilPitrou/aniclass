  ...
  for (index_md = 0; index_md < ptr->md_size; index_md++) {
    ...
    for (index_tt=0; index_tt<ptr->tt_size[index_md]; index_tt++) {
      ...
      if (_vectors_) {
        ...
        if ((ppt->has_cl_cmb_temperature == _TRUE_) && (index_tt == ptr->index_tt_t1_v))
          tp_of_tt[index_md][index_tt]=ppt->index_tp_t1_v;
        ...
        if ((ppt->has_cl_cmb_polarization == _TRUE_) && (index_tt == ptr->index_tt_b_v))
          tp_of_tt[index_md][index_tt]=ppt->index_tp_p;
      }
...
int transfer_can_be_neglected(
  ...
  *neglect = _FALSE_;
  ...
  if (_scalars_) {
    ...
    if ((ppt->has_cl_cmb_temperature == _TRUE_) && (index_tt == ptr->index_tt_t1_v) && (l < (k-ppr->transfer_neglect_delta_k_V_t1)*ra_rec)) *neglect = _TRUE_;
    ...
    else if ((ppt->has_cl_cmb_polarization == _TRUE_) && (index_tt == ptr->index_tt_b_v) && (l < (k-ppr->transfer_neglect_delta_k_V_b)*ra_rec)) *neglect = _TRUE_;
  ...
  *neglect = _FALSE_;
  ...
  if (l > ppr->transfer_neglect_late_source*ptr->angular_rescaling) {
    ...
    if (_scalars_) {
      ...
      if (ppt->has_cl_cmb_temperature == _TRUE_) {
        if ((index_tt == ptr->index_tt_t1_v) ||
            (index_tt == ptr->index_tt_t2))
          *neglect = _TRUE_;
      }
      if (ppt->has_cl_cmb_polarization == _TRUE_) {
        if ((index_tt == ptr->index_tt_e) ||
            (index_tt == ptr->index_tt_b_v))
          *neglect = _TRUE_;
      }
    }
    else if (_tensors_) {
